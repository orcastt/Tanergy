...
| — | [admin-dashboard.md](admin-dashboard.md) | 管理后台 Web 应用 | P1 | 高 | 5天 | 🔄 API 完成 |
...
admin-dashboard.md                  ← 🔄 API 已完成，Next.js 前端待开发
```
...
1. **管理后台前端** — Next.js Web App 开发（API 已完成）
2. **Slice 14 (模型注册表完善)** — 多模型路由细化
3. **端到端测试** — Docker + 迁移 + 完整流程验证
4. **Slice 20 (网页端预留)** — 架构规划
