...
**Updated**: 2026-05-14
**Status**: S1X Konva Page polish、S1D public share + owner-only copy/delete + known-foreign Asset guard hardening、S1C Clerk/Auth first pass、S3 admin/entitlement first pass，以及 staging Konva-only 部署恢复与真实 session/admin smoke 已接上的活跃交接报告；在 `p0-alpha-stabilization-and-acceptance-2026-05-06.md` 收口后，本文件继续作为更细粒度的验收清单。
...
1. 补完 staging 剩余浏览器验收
   signed-in board/browser, Google/email, final secret cleanup
   |
   v
2. S2 真实 AI provider 路径
