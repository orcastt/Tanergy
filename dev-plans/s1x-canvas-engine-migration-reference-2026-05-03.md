...
- Alt/Option drag rewrite: drag now uses a clean `KonvaShapeDragSession`; move/duplicate sessions freeze moving shapes and snap target bounds at dragStart, so copies can snap to other objects without snapping back to their source.
