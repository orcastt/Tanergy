...
**优先级**: P1 | **难度**: 高 | **预计**: 5-7 天 | **状态**: 🔄 API + 基础 Next.js 前端完成，当前补 Provider/Model 默认值、fallback、health/test
**返回索引**: [phase2-commercial.md](phase2-commercial.md)
**当前 P0**: [admin-provider-model-management-p0.md](admin-provider-model-management-p0.md)
...
> 2026-04-27 对齐：Admin 基础页面和 CRUD 自动验收已通过。下一步不是“从零开发后台”，而是补运营闭环：Provider 健康检查、模型默认值、fallback 优先级、模型能力标签、App 节点默认模型联动。
