...
export const MODEL_DEFS: Record<ModelCategory, ModelDef[]> = {
  ...
  image: [
    ...
    { id: "gemini-3.1-flash-image-preview", name: "Gemini 3.1 Flash Image Preview", provider: "geekai", category: "image" },
  ...
  image_edit: [
    { id: "gemini-3.1-flash-image-preview", name: "Gemini 3.1 Flash Image Preview", provider: "geekai", category: "image_edit" },
...
export const DEFAULT_MODELS: Record<ModelCategory, string> = {
  text: "nemotron-3-super-120b-a12b",
  image: "gpt-image-2",
