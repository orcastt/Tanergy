...
export const NODE_DEFS: NodeDef[] = [
  ...
  },
  {
    ...
    category: "ai",
    modelCategory: "text",
    defaultData: { style: "干货清单", promptOverride: "" },
    inputs: [
  ...
  },
  {
    ...
    category: "text",
    modelCategory: "text",
    defaultData: { target_words: 3000, style: "长文叙事" },
    inputs: [
  ...
  },
  {
    ...
    category: "image",
    modelCategory: "image",
    defaultData: { count: 1, quality: "low", image_size: "0.5K", imageInputs: ["img_in_1"] },
    inputs: [
  ...
  },
  {
    ...
    category: "output",
    modelCategory: "text",
    defaultData: { style: "standard_purple", fontSize: 16, lineHeight: 1.75, textInputs: ["text_1"], imageInputs: ["images"] },
    inputs: [
