...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::api_keys::set_app_config,
            commands::api_keys::get_app_config,
            ...
            commands::asset::ai_rewrite_html,
            commands::library::list_library_items,
            commands::library::list_library_tags,
            commands::library::create_library_item,
