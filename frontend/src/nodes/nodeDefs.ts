...
export const NODE_DEFS: NodeDef[] = [
  ...
  },
  {
    ...
    category: "text",
    modelCategory: "text",
    defaultData: { query: "", model: "hunyuan-3.0-preview" },
    inputs: [{ id: "in", type: "text", label: "Text" }],
  ...
  },
  {
    ...
    category: "ai",
    modelCategory: "text",
    defaultData: { style: "干货清单", model: "hunyuan-3.0-preview", promptOverride: "" },
    inputs: [
  ...
  },
  {
    ...
    category: "ai",
    modelCategory: "text",
    defaultData: { count: 3, style: "写实", model: "hunyuan-3.0-preview" },
  ...
  },
  {
    ...
    category: "image",
    modelCategory: "image",
    defaultData: { count: 1, model: "gpt-image-2", imageInputs: ["img_in_1"] },
    inputs: [
