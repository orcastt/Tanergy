...
- Workspace-gated editing and management: non-member share recipients stay view-only in the initial product direction.
- Team/Group workspace role policy: workspace admin/editor/viewer, Board `Can view/edit/manage/Owner` and AI payer eligibility are separate.
...
- Team admins may manage Team members and see Team billing usage only through workspace admin authority, not merely Board `Can manage`.
- Group admins may manage workspace/Board collaboration but cannot see another member's personal wallet usage.
...
- Workspace-gated editing and management：初始产品方向中，非 member share recipients 保持 view-only。
- Team/Group workspace role policy：workspace admin/editor/viewer、Board `Can view/edit/manage/Owner` 和 AI payer eligibility 是三套独立边界。
...
- Team admins 只能通过 workspace admin authority 管理 Team 成员和查看 Team billing usage，不能只靠 Board `Can manage`。
- Group admins 可以管理 workspace/Board collaboration，但不能查看其他成员的个人钱包 usage。
