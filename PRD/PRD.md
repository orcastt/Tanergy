...
- Billing, Team, Usage, Admin and AI route controls are first-pass bounded surfaces; the next business-system cut is role policy UI, payer settlement and real payment depth.
...
3. 围绕 Team wallet、personal Collaborate wallet 和可审计 usage 重建 S3 payer semantics。
