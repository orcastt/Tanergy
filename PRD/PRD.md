...
- Remaining S1X product work is polish and expansion: true rendered page-thumbnail assets/page duplicate/Move selection to new page, precise old-board style/binding migration if needed, real AiRun execution, transparent-background/export details and Phase 6 collaboration proof.
...
3. Continue true rendered page-thumbnail assets/page duplicate and real AiRun prep without adding new tldraw-only product work.
4. Prepare S1 Auth API contracts and S2 provider/AiRun contracts locally.
...
4. Real AI provider path through server-side AiRun.
5. Admin read-only MVP after real Auth/admin roles.
