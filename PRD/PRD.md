...
| S3 Admin/Billing/Analytics | `PRD_slice_S3_admin_billing_analytics.md` | Admin access, user management, credits, subscriptions, Team wallets, Group/Collaborate personal wallets, workspace dashboards, analytics, moderation | Active pivot: migration `20260508_0012/0013`, first payer resolver and settlement contracts, Team checkout/top-up, Collaborate checkout, signed payment webhook inbox, Group create, workspace invite contracts, minimal frontend actions and disposable Postgres smoke now support Team wallet vs personal Collaborate wallet; real payment-provider session mapping, finance reconciliation and production provider settlement remain pending |
