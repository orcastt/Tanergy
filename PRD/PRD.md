...
| S1X Canvas Engine Migration | `PRD_slice_S1X_canvas_engine_migration.md` | Production license risk, tldraw reference parity, Konva/Yjs handfeel and collaboration viability | Phase 3 object editing in progress; Frame/Sticky first pass and opaque fill fix added |
