...
export function createSeedShapes(): CanvasShape[] {
  return [
    ...
    { id: 'seed-frame', props: { height: 170, title: 'Frame', width: 260 }, style: { dash: 'solid', fillStyle: 'none', stroke: '#6b7280', strokeWidth: 2 }, type: 'frame', x: 76, y: 280 },
    { id: 'seed-sticky', props: { height: 124, text: 'Sticky note', width: 156 }, style: { fillStyle: 'solid', stroke: '#d6a20b', strokeWidth: 2 }, type: 'sticky', x: 380, y: 300 },
  ]
}
