  ...
  return (
    <>
      ...
      >
        ...
        <MenuDivider />
        <MenuButton disabled={!hasSelection} label="Bring to front" onClick={() => onAction('layer-front')} />
        <MenuButton disabled={!hasSelection} label="Send to back" onClick={() => onAction('layer-back')} />
        <MenuDivider />
