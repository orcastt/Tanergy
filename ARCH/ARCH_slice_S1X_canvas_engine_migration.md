...
- Context menu command depth is capped at two levels. Higher-level groupings such as Arrange use section labels inside one submenu panel instead of nested submenu panels, with a hover bridge to keep pointer travel stable.
