...
| S1X Canvas Engine Migration | `ARCH_slice_S1X_canvas_engine_migration.md` | tldraw license risk, current canvas reference contract, Konva/Yjs replacement path | Phase 3 object editing foundation in progress; box select, resize and undo/redo first pass |
