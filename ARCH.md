...
| `app/api/boards` | 当前 Board save guard、local save/load 开发路由 | 替代正式 Dashboard / DB persistence / 权限模型 |
...
| `features/boards` | Board document guard / serializer / restore / local client | 保存图片二进制、`blob:`、`data:` 或 base64 payload |
