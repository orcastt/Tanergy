...
from tangent_api.ai_provider_geekai_image_requests import run_geekai_image_attempt
    ...
    *,
    ...
    try:
        with httpx.Client(timeout=timeout_seconds) as client:
            outputs = run_geekai_image_attempt(
                client,
                api_key,
                base_url,
                payload,
        ...
        return _failure(route, "provider_transport_error", str(exc), retryable=False, started_at=started_at, work_started=True)
    except ValueError as exc:
        return _failure(route, "provider_response_invalid", str(exc), retryable=False, started_at=started_at, work_started=True)
